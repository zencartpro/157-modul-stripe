...
define('MODULE_PAYMENT_STRIPE_TEXT_DESCRIPTION_CHECKOUT_PAYMENT', 'Pay with <b>Credit Card</b>, <b>Amazon Pay</b>, <b>Google Pay</b>, <b>Apple Pay</b> and <b>more payment options</b>. The payment details are entered in the next step.');
...
define('MODULE_PAYMENT_STRIPE_TEXT_DESCRIPTION' , 'Stripe Payment Module <br> When testing credit card transactions, use a test Visa card 4242 4242 4242 4242.<br><br>IMPORTANT: After changing the API key, You must follow the steps below<br> .
